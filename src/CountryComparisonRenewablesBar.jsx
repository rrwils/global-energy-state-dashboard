...
export const ResponsiveCountryComparisonRenewablesBar = (props) => {
    const chartRef = useRef(null);
    const chartSize = useDimensions(chartRef);

    return (
        <div ref={chartRef} style ={{ width: '100%', height: 400 }}>
            <CountryComparisonRenewablesBar 
...
export const CountryComparisonRenewablesBar = ({ width, height, data, selectedCountry, setSelectedCountry }) => {
    ...
    const renewablesData = country2024data.map(d => ({
        country: d.country,
        renewables: (d.hydro + d.wind + d.solar + d.biofuel + d.other_renewable)
    }))
    ...
    const maxValues = d3.max(renewablesData, d => d.renewables);
